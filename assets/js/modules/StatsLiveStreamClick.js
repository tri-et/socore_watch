...
class StatsLiveStreamClick {
  constructor() {
    this.btnStats = $(
      '.prediction-detail-content--header-team--stats-livestream-menu>div div',
    )
    this.statsLiveStreamContent = $(
      '.prediction-detail-content--stats-livestream-content>div',
    )
  ...
  menuStatsLiveStreamClick(item) {
    ...
    $(item.currentTarget).addClass(
      'prediction-detail-content--header-team--active',
    )
    this.statsLiveStreamContent.removeClass(
