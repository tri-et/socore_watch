...
<body>
    <header class="header-menu">
        <nav class="primary-nav">
            <ul>
                <li><i class="fa fa-bars primary-nav--icon-menu-bar"></i>
                </li>
                <li>
                    ...
                    <div class="inplay-pregame--content">
                        <div class="row row__inplay inplay-pregame--inplay">
                            <div class="header-title header-title--livescore">
                                ...
                                <div><span>Germany Oberliga Bade-Wurttemberg</span>
                                </div>
                            </div>
    ...
    <div class="side-bar-menu">
        <div class="side-bar-search-content" onclick="event.cancelBubble=true;">
            ...
            <div class="side-bar-search-content--input-search">
                <img height="30" src="<?php echo base_url()?>assets/images/search.png" width="30">
                    ...
                    <nav>
                        <ul>
                            <li data-menu-type="predictions">
                                <a>
                                    <div class="sidebar-list-menu--activemenu"></div><img src="<?php echo base_url()?>assets/images/menu_predictions@1x.png"><span>predictions</span>
                                </a>
                            </li>
                            <li data-menu-type="livescore">
                                <a>
                                    <div></div><img class="sidebar-list-menu--icon-livescores" src="<?php echo base_url()?>assets/images/menu_livescores@1x.png"><span>live scores</span>
                                </a>
                            </li>
                            <li data-menu-type="help">
                                <a>
                                    <div></div><img class="sidebar-list-menu--icon-help" src="<?php echo base_url()?>assets/images/icon_help@1x.png"><span>help</span>
                                </a>
                            </li>
                            <li data-menu-type="aboutus">
                                <a>
                                    <div></div><img src="<?php echo base_url()?>assets/images/menu_aboutus@1x.png"><span>about us</span>
                                </a>
                            </li>
    ...
    <div class="help-container">
        <div class="help-content" onclick="event.cancelBubble=true;">
            ...
            <div class="help-content--content">
                <ul>
                    <li>
                        <div><img src="<?php echo base_url()?>assets/images/help-1.png" alt="">
                        </div>
                        <div>
                    ...
                    <li>
                        <div><img src="<?php echo base_url()?>assets/images/help-2.png" alt="">
                        </div>
                        <div>
                    ...
                    <li>
                        <div><img src="<?php echo base_url()?>assets/images/help-3.png" alt="">
                        </div>
                        <div>
                    ...
                    <li>
                        <div><img src="<?php echo base_url()?>assets/images/help-4.png" alt="">
                        </div>
                        <div>
